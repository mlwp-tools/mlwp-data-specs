"""Trait structural specs adapted from mxalign."""
...
SPACE_SPECS: dict[Space, PropertySpec] = {
...
TIME_SPECS: dict[Time, PropertySpec] = {
...
UNCERTAINTY_SPECS: dict[Uncertainty, PropertySpec] = {
